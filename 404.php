...
function genesis_404() {
	...
	if ( genesis_html5() ) :
		...
		echo apply_filters( 'genesis_404_entry_content', '<div class="row row--bg2"><div class="wrap-3 intro"><p>' . sprintf( __( 'Sorry, the page you\'re looking for doesn\'t seem to exist. Perhaps you can return back to the site\'s <a href="%s">homepage</a> and see if you can find what you are looking for. Or, use the navigation at the top of this page.', 'genesis' ), trailingslashit( home_url() ) ) . '</p>' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
		//get_search_form();
